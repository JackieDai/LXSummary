...
protocol KioskCycleViewDelegate: AnyObject {
    ...
    func cycleViewBeginDragingIndex(_ cycleView: KioskCycleView, index: Int)

    func cycleViewDidScrollToIndex(_ cycleView: KioskCycleView, index: Int)

    func cycleViewDidSelectedIndex(_ cycleView: KioskCycleView, index: Int)

    func cycleViewConfigurePageControl(_ cycleView: KioskCycleView, pageControl: UIPageControl)
}

class KioskCycleView: UIView {
    ...
    /// delegate
    public weak var delegate: KioskCycleViewDelegate? {
        didSet {
    ...
    private lazy var flowLayout: KioskCycleLayout = {
        let layout = KioskCycleLayout()
...
extension KioskCycleView: UICollectionViewDelegate, UICollectionViewDataSource {
